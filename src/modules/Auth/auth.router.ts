...
import { activatedAccount, getUser, login, logout, register, resetPassword, sendForgetPassword } from "./auth.controller";
import { activateSchema, forgetPasswordSchema, loginSchema, registerSchema, resetPasswordSchema } from "./auth.validation";
